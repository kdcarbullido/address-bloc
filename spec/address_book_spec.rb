...
RSpec.describe AddressBook do
  ...
  describe "#iterative_search" do
    it "iteratively searches AddressBook for a non-existent entry" do
      book.import_from_csv("entries.csv")
      entry = book.iterative_search("Dan")
      expect(entry).to be_nil
    end

    it "iteratively searches AddressBook for Bill" do
      book.import_from_csv("entries.csv")
    ...
    it "iteratively searches AddressBook for Bob" do
      book.import_from_csv("entries.csv")
    ...
    it "iteratively searches AddressBook for Joe" do
      book.import_from_csv("entries.csv")
    ...
    it "iteratively searches AddressBook for Sally" do
      book.import_from_csv("entries.csv")
    ...
    it "iteratively searches AddressBook for Sussie" do
      book.import_from_csv("entries.csv")
    ...
    it "iteratively searches AddressBook for Billy" do
      book.import_from_csv("entries.csv")
